#WRITTEN BY MR.DIPTO
#FOLLOW : https://youtu.be/kc-K854oVyk?si=ZEugXcU6gCB7Zcuv
#------------- import -------------#
import os
...
╚██╗░██╔╝██║██████╔╝██║░░██║██████╔╝██║
 ...
 ░░╚██╔╝░░██║██║░░██║╚█████╔╝██║░░██║██║
 ░░░╚═╝░░░╚═╝╚═╝░░╚═╝░╚════╝░╚═╝░░╚═╝╚═╝{M}
 Owner    : {M}HYDRA BY VIRORI
 YOUTUBE    : HYDRA BY VIRORI
 Facebook : HYDRA BY VIRORI
 Tools    : F{M}/{M}R{M}/{M}G{M} •{warna}[{M}TRAIL{warna}]{warna}
--------------------------------------------{M}''')
#-------------linex def -------------#
def linex():
    print(f'{warna}--------------------------------------------{M}')
...
def MR_DIPTO():
    ...
    print(f'{B} [{warna}01{B}] RANDOM CLONING HYDRA BY VIRORI')
    print(f'{B} [{warna}00{B}] EXIT TERMINAL HYDRA BY VIRORI')
    linex()
